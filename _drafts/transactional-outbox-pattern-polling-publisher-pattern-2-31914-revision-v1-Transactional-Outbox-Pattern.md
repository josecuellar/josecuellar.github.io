...
<figure class="wp-block-image size-large is-style-rounded">![](https://josecuellar.net/wp-content/uploads/2020/04/image-7.png)<figcaption>*Modern databases offer distributed ACID, Sid Choudhury*</figcaption></figure>*Con objetivo de simplificar la infraestructura y con este tipo de opciones: podríamos unificar el repositorio de lectura y escritura (adaptándolo y configurando las características en cada caso y según necesidades) mediante un único servicio de base de datos.*
...
<div class="wp-block-image is-style-default"><figure class="aligncenter size-full is-resized">![](https://josecuellar.net/wp-content/uploads/2020/04/image-11.png)</figure></div>**La transacción y el envío del evento, no son atómicos: se ejecutan independientemente.** Quizás falle alguno o ambos. Provocando una inconsistencia de datos.
...
<div class="wp-block-image is-style-default"><figure class="aligncenter size-large is-resized">![](https://josecuellar.net/wp-content/uploads/2020/04/image-12.png)</figure></div>Mediante **Polling Publisher Pattern** publicaríamos los eventos a nuestro *message-broker* manteniendo el estado de los eventos del *outbox* comprobando *ACK* en el momento de la publicación del envío, asegurando así la recepción del evento. O incluso, el consumidor podría actualizar el estado a procesado correctamente mediante un *CorrelationId*.
...
<figure class="wp-block-embed"><div class="wp-block-embed__wrapper">https://docs.particular.net/nservicebus/outbox </div></figure><figure class="wp-block-embed"><div class="wp-block-embed__wrapper">https://github.com/dotnetcore/CAP </div></figure>