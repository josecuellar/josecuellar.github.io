...
| Data Driven | Encourages evidence-based decisions. |
| Critical Thinking | Challenges assumptions and improves learning. |
| Learning Capacity | Accelerates adaptation. |
| Flexibility & Empathy | Improves collaboration across disciplines. |
| Problem Solving | Helps overcome uncertainty and complexity. |
| Passion & Enthusiasm | Sustains energy through change. |
| Eager to Evolve | Promotes continuous improvement. |
| Impact | Focuses effort where it creates the greatest value. |
| Accountability | Reinforces ownership and trust. |
| Team Player | Strengthens collective performance. |
